...
hosts were contacted by guests with names that signaled African American males, African American females, white males, and white females from birth certificates of babies born between 1974 and 1979 in Massachusetts.
### Digital Enhanced Experiment: 
...
This paper analyzed the potential discrimination in the online short-term rent market. More specifically we know that a black guest is 8% less likely to receive a positive response compared to the person with identical profile except the name. 
...
To begin with, we should note that usually in any filed experiment design, it requires supplementary design of observation data collection. For example. in experiment paper of this take home exam, on one hand, the author conducted a field experiment to get a responsive rate data of different race. On the other hand, the digital trace data of the landlord, and the property are collected to enhance their digital experiment design.  
